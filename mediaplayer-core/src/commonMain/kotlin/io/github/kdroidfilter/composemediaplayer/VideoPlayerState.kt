@file:JvmName("VideoPlayerStateCoreKt")
...
interface VideoPlayerState {
     ...
     *
     * **You do not need to call this manually** when using the Compose lifecycle-aware
     * `rememberVideoPlayerState` helpers. They automatically call [dispose]
     * via a [androidx.compose.runtime.DisposableEffect] when the composable leaves the composition.
     *
     * Only call this directly if you create the state manually outside a composable lifecycle:
     * ```
...
fun String.normalizedAssetPath(): String {
...
@ExperimentalComposeMediaPlayerBackendApi
fun String.normalizedAssetUri(): String = "asset:///${normalizedAssetPath()}"

@ExperimentalComposeMediaPlayerBackendApi
fun Map<String, String>.sanitizedRequestHeaders(): Map<String, String> =
...
@ExperimentalComposeMediaPlayerBackendApi
fun Map<String, String>.requestHeadersLineString(lineSeparator: String = "\r\n"): String =
    sanitizedRequestHeaders()
        .entries
        .joinToString(lineSeparator) { (name, value) -> "$name: $value" }

@ExperimentalComposeMediaPlayerBackendApi
fun Map<String, String>.requestHeadersJsonObjectString(): String =
    sanitizedRequestHeaders()
        .entries
