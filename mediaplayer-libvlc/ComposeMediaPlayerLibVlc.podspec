Pod::Spec.new do |spec|
    spec.name                     = 'ComposeMediaPlayerLibVlc'
    spec.version                  = '0.0.1-dev'
    spec.homepage                 = 'https://github.com/SuvioMedia/KMediaPlayer'
    spec.source                   = { :http=> ''}
    spec.authors                  = ''
    spec.license                  = ''
    spec.summary                  = 'Optional bundled libVLC 4 backend for Compose Media Player'
    ...
    if !Dir.exist?('build/cocoapods/framework/ComposeMediaPlayerLibVlc.framework') || Dir.empty?('build/cocoapods/framework/ComposeMediaPlayerLibVlc.framework')
        ...
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:
            ./gradlew :mediaplayer-libvlc:generateDummyFramework
    ...
    spec.pod_target_xcconfig = {
        'KOTLIN_PROJECT_PATH' => ':mediaplayer-libvlc',
        'PRODUCT_MODULE_NAME' => 'ComposeMediaPlayerLibVlc',
    }
    spec.script_phases = [
        {
            :name => 'Build ComposeMediaPlayerLibVlc',
