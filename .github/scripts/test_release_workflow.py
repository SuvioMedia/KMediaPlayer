...
class ReleaseWorkflowTest(unittest.TestCase):
    ...
    def test_apple_mpv_graph_uses_the_runtime_required_by_kmedia_mpv(self) -> None:
        ...
        self.assertIn("MPV_VERSION: 0.3.0-rc.11", build_natives)
        self.assertIn("RUNTIME_VERSION: 0.1.0-rc.7", build_natives)
        self.assertIn("KMediaMpvMoltenVK", verifier)
        self.assertIn("KMEDIA_FFMPEG_RUNTIME_VERSION:-0.1.0-rc.7", verifier)
        self.assertIn('kmediaFfmpegRuntimeVersion = "0.1.0-rc.7"', mpv_build)
        self.assertIn("KMediaAssRuntime', '0.1.0-rc.7'", podspec)
        self.assertIn("KMediaFfmpegRuntime', '0.1.0-rc.7'", podspec)
    ...
    def test_every_native_ass_consumer_uses_one_runtime_version(self) -> None:
        ...
        self.assertIn("0.1.0-rc.7", source)
