    ...
    repositories {
        ...
        exclusiveContent {
            ...
            filter {
                ...
                includeModule("io.github.shusek", "composemediaplayer-ads-core")
                includeModule("io.github.shusek", "composemediaplayer-ads-core-android")
                includeModule("io.github.shusek", "composemediaplayer-ads-core-jvm")
