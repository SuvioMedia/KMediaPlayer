...
- **Media3** for Android
- **@shusek/movi-player 0.3.5-kmp.3** for WASM, with native HTML5 video available as an explicit non-adaptive compatibility mode
