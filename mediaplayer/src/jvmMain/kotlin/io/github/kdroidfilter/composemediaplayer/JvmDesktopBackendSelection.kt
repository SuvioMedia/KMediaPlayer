...
internal const val JVM_DESKTOP_BACKEND_UNSUPPORTED_NATIVE_VIEW = "unsupported-native-view"
...
internal fun VideoPlaybackOptions.forcedJvmDesktopBackend(): String? =
    when (desktopVideoBackend) {
        ...
        DesktopVideoBackend.LIBVLC_NATIVE -> JVM_DESKTOP_BACKEND_UNSUPPORTED_NATIVE_VIEW
        DesktopVideoBackend.PLATFORM -> JVM_DESKTOP_BACKEND_PLATFORM
        DesktopVideoBackend.AUTO ->
            null
    }

internal fun unsupportedDesktopNativeVideoSurfaceException(): UnsupportedOperationException =
