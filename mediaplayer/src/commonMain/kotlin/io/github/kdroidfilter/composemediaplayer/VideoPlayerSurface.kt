 ...
 *
 * @param playerState A library-backed or preview [VideoPlayerState]. Passing a custom state that
 *                    has no platform video implementation fails with a descriptive error.
