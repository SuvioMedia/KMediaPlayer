...
internal val VideoProjectionSettings.isDefaultProjectionSettings: Boolean
    get() =
        normalized().let { projection ->
            projection.projectionType == VideoProjectionType.Flat &&
                projection.stereoLayout == VideoStereoLayout.Mono &&
...
internal fun VideoProjectionViewControlMode.usesDeviceMotionFor(projection: VideoProjectionSettings): Boolean =
    when (this) {
...
internal fun VideoProjectionSettings.renderingInfoLabel(): String? {
...
internal val VideoProjectionType.projectionShaderCode: Int
    get() =
        when (this) {
