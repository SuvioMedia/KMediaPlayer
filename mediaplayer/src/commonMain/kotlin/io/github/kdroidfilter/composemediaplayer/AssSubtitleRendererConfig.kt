 ...
 *
 * JASSUB wraps libass for browser targets. The bundled npm package provides
 * the default worker/WASM/font assets; these URLs are optional overrides for
 * production apps that need to self-host them.
 */
